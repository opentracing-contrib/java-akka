...
public class DistributedTracedMessageTest {
    ...
    public void testImplicitActiveSpan() {
        ...
        assertEquals(span.context().toTraceId(), tracedMessage.activeSpan(mockTracer).context().toTraceId());
        assertNotEquals(span.context().toSpanId(), tracedMessage.activeSpan(mockTracer).context().toSpanId());
